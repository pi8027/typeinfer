...
\begin{enumerate}
  ...
  \item
    ...
    代入に $?_4 \mapsto ?_5 \to ?_6$ を追加します。
  \item
    \begin{description}
      \item[等式集合]
        $\{?_3 \to ?_2 = ?_1, (?_5 \to ?_6) \to ?_3 = ?_1, ?_6 = ?_5\}$
      \item[代入]
        $\{?_0 \mapsto ?_1 \to ?_2, ?_4 \mapsto ?_5 \to ?_6\}$
    \end{description}
    等式 $?_3 \to ?_2 = ?_1$ を解きます。
    一方が変数なので、等式集合と代入の $?_1$ を全て $?_3 \to ?_2$ に置き換え、
    代入に $?_1 \mapsto ?_3 \to ?_2$ を追加します。
  \item
    \begin{description}
      \item[等式集合]
        $\{(?_5 \to ?_6) \to ?_3 = ?_3 \to ?_2, ?_6 = ?_5\}$
      \item[代入]
        $\{?_0 \mapsto (?_3 \to ?_2) \to ?_2, ?_1 \mapsto ?_3 \to ?_2, ?_4 \mapsto ?_5 \to ?_6\}$
    \end{description}
  ...
  \item
    ...
    代入に $?_3 \mapsto ?_5 \to ?_6$ を追加します。
  \item
    \begin{description}
      \item[等式集合]
        $\{?_5 \to ?_6 = ?_2, ?_6 = ?_5\}$
      \item[代入]
        $\{?_0 \mapsto ((?_5 \to ?_6) \to ?_2) \to ?_2, ?_1 \mapsto (?_5 \to ?_6) \to ?_2,
           ?_3 \mapsto ?_5 \to ?_6, ?_4 \mapsto ?_5 \to ?_6\}$
    \end{description}
    等式 $?_5 \to ?_6 = ?_2$ を解きます。
    一方が変数なので、等式集合と代入の $?_2$ を全て $?_5 \to ?_6$ に置き換え、
    代入に $?_2 \mapsto ?_5 \to ?_6$ を追加します。
  \item
    \begin{description}
      \item[等式集合]
        $\{?_6 = ?_5\}$
      \item[代入]
        $\{?_0 \mapsto ((?_5 \to ?_6) \to ?_5 \to ?_6) \to ?_5 \to ?_6,
           ?_1 \mapsto (?_5 \to ?_6) \to ?_5 \to ?_6, ?_2 \mapsto ?_5 \to ?_6,
           ?_3 \mapsto ?_5 \to ?_6, ?_4 \mapsto ?_5 \to ?_6\}$
    \end{description}
    等式 $?_6 = ?_5$ を解きます。
    一方が変数なので、等式集合と代入の $?_6$ を全て $?_5$ に置き換え、
    代入に $?_6 \mapsto ?_5$ を追加します。
  \item
    \begin{description}
      \item[等式集合]
        $\{\}$
      \item[代入]
        $\{?_0 \mapsto ((?_5 \to ?_5) \to ?_5 \to ?_5) \to ?_5 \to ?_5,
           ?_1 \mapsto (?_5 \to ?_5) \to ?_5 \to ?_5, ?_2 \mapsto ?_5 \to ?_5,
           ?_3 \mapsto ?_5 \to ?_5, ?_4 \mapsto ?_5 \to ?_5, ?_6 \mapsto ?_5\}$
    \end{description}
...
この計算は、制約集合を取り、それを解いた結果として得られる型変数への代入を返すとしましょう。
