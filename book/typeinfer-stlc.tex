...
このことから、ユニフィケーションのアルゴリズムは停止すると言えます。

また、このような単一化のアルゴリズムは、解が存在しない場合のみにエラーを報告し、
そうでない場合は正しい解を返し、かつその解は最も一般的な解であることが保証されています。

最も一般的な解を返すという性質から、型推論が最も一般的な型を推論するといえます。
